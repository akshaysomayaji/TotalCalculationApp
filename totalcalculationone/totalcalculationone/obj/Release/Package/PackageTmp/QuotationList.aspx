...
<body>
    ...
    <Columns>
        ...
        <asp:BoundField ItemStyle-Width="150px" DataField="QuotationNumber" HeaderText="Quotation No." >
...
<ItemStyle Width="150px"></ItemStyle>
        ...
        <asp:HyperLinkField
            ...
            HeaderText="Freight Report"
            Text="Report" />
         <asp:HyperLinkField
            DataNavigateUrlFields="QuotationNumber"
            DataNavigateUrlFormatString="~\OceanReports.aspx?QuotationNumber={0}"
            HeaderText="Ocean Report"
            Text="Report" />
    </Columns>
