...
{
    public partial class OceanReports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            report1.Load(Server.MapPath("~/OceanReport.rpt"));
            ...
            OceanRep.ReportSource = report1;
            OceanRep.AllowedExportFormats = (int)CrystalDecisions.Shared.ViewerExportFormats.PdfFormat;
        ...
        protected void Export(object sender, EventArgs e)
        {
            ...
            report1.ExportToHttpResponse(formatType, Response, true, "OceanQuotation");
            Response.End();
