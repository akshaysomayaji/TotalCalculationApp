...
namespace DataObjects
{
    ...
    public static class Extensions
    {
        ...
        /// <summary>
        /// Transform object into short integer data type.
        /// </summary>
        /// <param name="item">The object to be transformed.</param>
        /// <param name="defaultId">Optional default value is default(Int16).</param>
        ...
        /// </summary>
        /// <param name="item">The object to be transformed.</param>
        /// <param name="defaultId">Optional default value is default(Int64).</param>
        ...
        public static DateTime AsFormatDateTime(this object item, DateTime defaultDateTime = default(DateTime))
        {
            if (item == null || item.Equals(System.DBNull.Value))
                return defaultDateTime;
            string format = "dd-M-yy";
            return Convert.ToDateTime(Convert.ToDateTime(item).ToString(format));
        }


        public static DateTime? AsNullDateTime(this object item, DateTime defaultDateTime = default(DateTime))
        {
        ...
        public static int AsBool1or0(this object item, int defaultFalse = 0)
        {
            if (item == null)
                return defaultFalse;
            if (item.ToString().ToLower().Contains("true"))
            {
                return 1;
            }
            else
